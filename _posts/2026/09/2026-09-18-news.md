...
news_counter: 12
last_updated: 2026-09-22 12:25:12 JST
---
...
- **Link**: [https://docs.cloud.google.com/release-notes#September_18_2026](https://docs.cloud.google.com/release-notes#September_18_2026)
- **Published**: 2026-09-18 16:00:00
- **Fetched**: 2026-09-18 21:43:46
...
- **Link**: [https://cloud.google.com/blog/ja/products/maps-platform/introducing-large-vehicle-routing-address-the-unique-logistics-needs-of-large-vehicle-fleets/](https://cloud.google.com/blog/ja/products/maps-platform/introducing-large-vehicle-routing-address-the-unique-logistics-needs-of-large-vehicle-fleets/)
- **Published**: 2026-09-18 11:00:00
- **Fetched**: 2026-09-22 12:25:12

<details class="entry-summary">
<summary>詳細を表示</summary>
<div class="block-paragraph_advanced"><p><span style="vertical-align: baseline;">トラックやバスなどの大型車両の運用には、特有の課題が伴います。ドライバーは、高さ制限のある橋や道幅の狭いトンネル、急カーブといった走行上の物理的制約を把握しておく必要があります。さらに車両の運行管理者は、地域、州、国ごとに異なる道路網の規制を考慮して計画を立てる必要があります。</span></p>
<p><span style="vertical-align: baseline;">こうした課題に対し、このたび米国において、Routes API、Route Optimization API、Navigation SDK に大型車両向けルート検索（LVR）機能の一般提供を開始したことをお知らせします。LVR は、物流会社、車両運行管理者、大型車両ドライバー向けに特別に構築されており、商用車や特殊車両に固有の要件を満たすように設計されています。大型車両ならではの物理的特性や、実際に直面する道路上の制約を考慮した、高度に最適化されたルートを提供できる機能です。</span></p>
<p><span style="vertical-align: baseline;">従来のルート検索アルゴリズムは普通乗用車のルートや走行速度に合わせて最適化されているため、大型車両に影響する特有の要素までは考慮されていないのが一般的です。そのため、車両管理者やドライバーは手作業での確認や土地勘に頼らざるを得ず、ルート設定やナビゲーションの方法が非効率的で安全性を欠いた持続可能性の低いものになりがちです。LVR は、現実世界の車両と道路の制約をルート検索のロジックに直接統合する、API ドリブンなソリューションを実現します。</span></p>
<h3><span style="vertical-align: baseline;">料金設定と計画の精度を向上</span></h3>
<p><span style="vertical-align: baseline;">既存の Routes API と Route Optimization API を使用して LVR を導入すると、大型車両のニーズを考慮した、より正確なルートを実現できます。物流会社は LVR を使用して次のことができます。</span></p>
<ul>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">高さ、重量、長さ、幅、車軸数、危険物の分類など、車両の詳細なプロファイルを指定する。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">実現可能性と車両の進入可否を考慮した 1 台の車両または車両群のルート計画を最適化し、全体的な運用効率を向上させる。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">Google の包括的な道路データと交通モデルを使用して、車両の属性に合わせたルート、移動時間、移動距離を算出する。</span></p>
</li>
</ul></div>
<div class="block-image_full_width">
    ...
    <figure class="article-image--large
      ...
      ">
        ...
        <img alt="LVR-1" src="https://storage.googleapis.com/gweb-cloudblog-publish/images/LVR-1.max-1000x1000.png" />
        
        </a>
      
        <figcaption class="article-image__caption "><p>商用ルートを比較し、費用面や運用面でメリットがある場合は動的に有料道路を回避します。</p></figcaption>
...
<div class="block-paragraph_advanced"><h3><span style="vertical-align: baseline;">車両群全体の運用を効率化</span></h3>
<p><span style="vertical-align: baseline;">ルートとルート最適化機能により、1 か所または複数か所に立ち寄るルートや、複数台の車両の 1 日または 1 週間の運行計画を立てることができます。ドライバーに道路制約を考慮したルートを提示しながら、時間や工数、走行距離を削減できます。さらに、</span><a href="https://developers.google.com/maps/documentation/route-optimization/polylines-and-route-tokens?hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">ルートトークン</span></a><span style="vertical-align: baseline;">を使用することで、計画したルートどおりの道案内を確実にドライバーに表示することが可能です。LVR を使用して、車両運行管理者は次のことができます。</span></p>
<ul>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">大型車両に特化した新しい到着予定時刻モデルを使用して、より正確な到着予定時刻を計算する。このモデルは、観測された大型車の走行速度と、リアルタイムの交通データおよび予測交通データを組み合わせて、大型車向けのより正確な推定値を提供します。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">ドライバーやオペレーターが使い慣れたインターフェースで、信頼できるエクスペリエンスを構築する。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">ルートトークンを活用して、道路の制約を考慮したルート計画の詳細を Routes API から Navigation SDK へ渡し、管理者の計画とドライバーによる実際の走行を確実に一致させる。</span></p>
</li>
</ul></div>
<div class="block-image_full_width">
    ...
    <figure class="article-image--large
      ...
      ">
        ...
        <img alt="LVR-2" src="https://storage.googleapis.com/gweb-cloudblog-publish/images/LVR-2.max-1000x1000.png" />
        
        </a>
      
        <figcaption class="article-image__caption "><p>時間、走行距離、その他のビジネス上の制約を考慮して最適化し、最も効率的なルートの組み合わせを算出します。Route Optimization API を使用すると、一連の経由地、車両数、車両の制約条件を組み込むことができます。</p></figcaption>
...
<div class="block-paragraph_advanced"><h3><span style="vertical-align: baseline;">ドライバーの安心感と効率性を高める</span></h3>
<p><span style="vertical-align: baseline;">Routes API は最適ルートを提供し、Navigation SDK は Google マップと同様のインターフェースでそのルートを表示します。機能の吹き出しが追加され、走行ルート上の制約の特定と認識が容易になりました。Navigation SDK は、運送業者が提供する既存のアプリケーションに組み込むことができます。そのため、ドライバーにとって使いやすく、計画ルートの取得から確認までをシームレスに行えます。Navigation SDK で LVR を有効にすると、ドライバーがルート上の制約を視覚的に確認しながら、トラックなどの大型車両向けのターンバイターンのナビゲーションを利用できるようになります。また、高さ制限や重量制限など、車両サイズに応じた制約を表示することも可能です。</span></p></div>
<div class="block-image_full_width">
    ...
    <figure class="article-image--medium
      ...
      ">
        ...
        <img alt="LVR-3" src="https://storage.googleapis.com/gweb-cloudblog-publish/images/LVR-3.max-1000x1000.jpg" />
        
        </a>
      
        <figcaption class="article-image__caption "><p>LVR と Navigation SDK を組み合わせることで、アプリ内でのシームレスなナビゲーションが実現し、ドライバーが使い慣れた信頼性の高い Google マップのガイダンスを運転席で直接利用できるようになります。</p></figcaption>
...
<p><span style="vertical-align: baseline;">大型車両向けルート検索で広がる可能性を、ぜひご体験ください。配送トラックのフリートの最適化、複雑な重量物輸送の計画、危険物の輸送などに必要な精度とインテリジェンスを LVR は提供します。詳細については、</span><a href="https://mapsplatform.google.com/maps-products/routes/#large-vehicle-routing" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">ウェブページ</span></a><span style="vertical-align: baseline;">と</span><a href="https://developers.google.com/maps/documentation/routes/lvr?hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">ドキュメント</span></a><span style="vertical-align: baseline;">をご覧ください。</span></p>
<p><span style="font-style: italic; vertical-align: baseline;">- Google Maps Platform、プロダクト マネージャー、</span><strong style="font-style: italic; vertical-align: baseline;">Mohit Moondra</strong></p></div>
</details>

### ドライバーのリアルタイムの可視性、道路網を考慮した境界線、アプリ内でのユーザー維持により、業務効率を合理化

- **Link**: [https://cloud.google.com/blog/ja/products/maps-platform/streamline-business-efficiency-with-real-time-driver-visibility-network-aware-boundaries-and-in-app-user-retention/](https://cloud.google.com/blog/ja/products/maps-platform/streamline-business-efficiency-with-real-time-driver-visibility-network-aware-boundaries-and-in-app-user-retention/)
- **Published**: 2026-09-18 11:10:00
- **Fetched**: 2026-09-22 12:25:12

<details class="entry-summary">
<summary>詳細を表示</summary>
<div class="block-paragraph_advanced"><p><span style="vertical-align: baseline;">人や物の移動、サービス車両の運用、あるいはアプリ内でのコンバージョン促進。そのあらゆる物理的な道のりとデジタルのタッチポイントが、ビジネスの成否を分ける重要な鍵となります。</span></p>
<p><span style="vertical-align: baseline;">このたび、新たに 3 つのプロダクトをリリースいたしました。</span></p>
<ul>
<li style="vertical-align: baseline;">
<p><a href="https://developers.google.com/maps/documentation/navigation/connect?utm_source=blog&amp;utm_campaign=Q2_theme1&amp;hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Navigation Connect API</span></a><span style="vertical-align: baseline;">（プレビュー版）: ドライバーのエンドツーエンドの可視性を維持します。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><a href="https://developers.google.com/maps/documentation/isochrones/demo?hl=en&amp;utm_campaign=Q2_theme1" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Isochrones API</span></a><span style="vertical-align: baseline;">（プレビュー版）: 実際の移動時間に基づいて、現実世界での到達可能性を高い精度でマッピングします。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><a href="https://mapsplatform.google.com/maps-products/places-ui-kit/?utm_source=blog&amp;utm_campaign=Q2_theme1" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Places UI キット Pro</span></a><span style="vertical-align: baseline;">（</span><a href="https://developers.google.com/maps/documentation/places/android-sdk/places-ui-kit-overview?utm_source=blog&amp;utm_campaign=Q2_theme1&amp;hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Android</span></a><span style="vertical-align: baseline;"> と </span><a href="https://developers.google.com/maps/documentation/places/ios-sdk/places-ui-kit-overview?utm_source=blog&amp;utm_campaign=Q2_theme1&amp;hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">iOS</span></a><span style="vertical-align: baseline;"> のモバイル SDK は一般提供中、ウェブ版は今秋一般提供予定）: ユーザー ジャーニー全体をアプリ内から直接エンドツーエンドで管理します。</span></p>
</li>
</ul>
<p><span style="vertical-align: baseline;">これらの最新プロダクトを活用することで、企業は道路状況の実際のデータや現実世界の場所が持つコンテキストを正確に把握できるようになります。これにより、配送や移動の失敗を減らし、コストの損失を最小限に抑え、コンバージョン率を最大限に高めることが可能になります。</span></p>
<h3><span style="vertical-align: baseline;">アプリを切り替えても、ドライバーの可視性を常に維持</span></h3>
<p><span style="vertical-align: baseline;">ドライバーが一般向けのナビゲーション アプリに切り替えてしまうと、状況に応じた適切な更新や円滑な業務運営に欠かせないリアルタイムのデータフローが途絶え、ビジネスに支障をきたすことになります。バックグラウンドでの位置情報の共有や、複数のソースから得た位置情報と到着予定時刻を継ぎはぎして利用するといった回避策では、十分な信頼性を確保できない場合があります。</span></p>
<p><span style="vertical-align: baseline;">Navigation Connect API を使用すれば、ドライバーを好みのアプリ（Google マップまたは Waze）に誘導しながら、リアルタイムの位置情報、正確な到着予定時刻、ルート外れのアラートなど、ビジネスに不可欠なルートデータを継続的にプラットフォームに返すことができます。これにより、ドライバーが好みのナビゲーション アプリを自由に使い続けられる環境を提供しながら、管理者側は可視性を損なうことなく、お客様への正確な状況報告と業務効率化を両立できます。</span></p>
<p><span style="vertical-align: baseline;">Navigation Connect API は、エンジニアリングに多大な工数をかけることなく可視性を確保したい企業向けに設計されています。軽量な Pub/Sub または API 統合だけで導入できるため、わずか半日という短期間で車両群の運用を劇的に改善し、統合コストと開発時間を大幅に削減することが可能です。</span></p>
<h4><span style="vertical-align: baseline;">車両に適したツールの選択</span></h4>
<p><a href="https://mapsplatform.google.com/maps-products/navigation-sdk/?utm_source=blog&amp;utm_campaign=Q2_theme1" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Google Maps Platform Navigation SDK</span></a><span style="vertical-align: baseline;"> は、UI を自在にコントロールし、ユーザーを自社のカスタム アプリケーション環境内に留める「埋め込み型のエクスペリエンス」を想定して設計されています。これに対し、新しい </span><a href="https://developers.google.com/maps/documentation/navigation/connect?utm_source=blog&amp;utm_campaign=Q2_theme1&amp;hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Navigation Connect API</span></a><span style="vertical-align: baseline;"> は、「ハンドオフ型のエクスペリエンス」に最適です。ネイティブなユーザーアプリを活用することで、迅速な実装とドライバーの使いやすさを実現すると同時に、配送や移動を確実に成功させ、顧客満足度を高めるために不可欠なサーバーサイドの可視性もしっかりと維持できます。</span></p></div>
<div class="block-image_full_width">
    ...
    <figure class="article-image--large
      ...
      ">
        ...
        <img alt="Nav-1" src="https://storage.googleapis.com/gweb-cloudblog-publish/images/nav-1.max-1000x1000.png" />
        
        </a>
      
        <figcaption class="article-image__caption "><p>使い慣れた Google マップと Waze のユーザー エクスペリエンスでビジネスに不可欠なデータを提供。</p></figcaption>
...
<div class="block-paragraph_advanced"><h3><span style="vertical-align: baseline;">Isochrones API で真の到達可能性をマッピング</span></h3>
<p><span style="vertical-align: baseline;">複雑な都市環境でビジネスを展開するには、道路網の実際のデータを反映した境界線が欠かせません。それがあって初めて、「今この瞬間、車で 15 分以内に到達できるのはどこか？」といった極めて重要な問いに答えることができるのです。単なる半径による円指定に頼ってしまうと、到着予定時刻の誤差が生じやすく、エリア管理の信頼性を損なう原因にもなりかねません。</span></p>
<p><span style="vertical-align: baseline;">Isochrones API は、道路網を考慮した境界線を生成し、特定の時間枠（車の場合は最大 60 分、徒歩または自転車の場合は最大 120 分）内に到達可能な範囲を秒単位の精度で正確に示します。標準的なルート検索にとどまらず、逆等時線を計算することで、インバウンド ルートや到着時間の最適化も可能です（たとえば、拠点となるフルフィルメント ハブへ戻る複数の配送ドライバーの動きを調整する場合などに有効です）。リアルタイム交通情報、道路網、さまざまな移動手段を考慮することで、物流を最適化し、動的な到着予定時刻に基づいてサービスゾーンを確認し、到着の信頼性を高めることができます。Isochrones API は、Google マップと同じ堅牢な道路網と交通データを利用して、標準の GeoJSON ポリゴンを返します。これにより、デベロッパーは抽象的な位置座標を、実用的で視覚的なルート決定に簡単に変換できます。</span></p>
<h4><span style="vertical-align: baseline;">モビリティと物流の最適化</span></h4>
<p><span style="vertical-align: baseline;">Isochrones API は、フリートと配送ネットワークにおける複雑なルーティングの課題を解決するように設計されています。</span></p>
<ul>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">配送エリアの最適化: リアルタイムの交通状況やドライバーの稼働状況に基づき、極めて効率的なサービス境界線を定義できます。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">配車と移動: 特定の運転時間内に到達できる電気自動車充電スタンドや最適なルートをドライバーが特定できるよう支援します。</span></p>
</li>
</ul>
<h4><span style="vertical-align: baseline;">他業界での活用</span></h4>
<p><span style="vertical-align: baseline;">物流以外にも、この API を使用して、デベロッパーは他の業界向けに位置認識エクスペリエンスを構築できます。</span></p>
<ul>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">不動産物件の検索: 通勤や通学を考慮した物件検索を提供し、購入希望者が単純な直線距離ではなく、職場や学校までの実際の移動時間に基づいて住宅を見つけられるようにします。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">都市計画: 緊急サービスへのアクセシビリティを可視化し、交通機関のカバー範囲を分析して、公共交通機関のルート配置を最適化します。</span></p>
</li>
</ul>
<p><span style="vertical-align: baseline;">Isochrones API を活用すれば、車、徒歩、自転車など、ユーザーの移動手段を問わず、指定の時間内に到達できるすべての場所を瞬時に可視化できます。これにより、最適なルートを提示し、最高レベルのユーザー エクスペリエンスを提供することが可能になります。</span></p></div>
<div class="block-image_full_width">
    ...
    <figure class="article-image--large
      ...
      ">
        ...
        <img alt="Nav-2" src="https://storage.googleapis.com/gweb-cloudblog-publish/images/Nav-2.max-1000x1000.png" />
...
<div class="block-paragraph_advanced"><h3><span style="vertical-align: baseline;">Places UI キット Pro でエンドツーエンドのユーザー ジャーニーを所有する</span></h3>
<p><span style="vertical-align: baseline;">ユーザーが目的地や場所を調べるためにアプリを離れるたびに、ユーザーを失うリスクが生じます。</span><a href="https://mapsplatform.google.com/maps-products/places-ui-kit/" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Places UI キット Pro</span></a><span style="vertical-align: baseline;"> は、モバイル版がすでに提供されており、ウェブ版は今秋に提供予定です。このローコード コンポーネント ライブラリは、豊富なプレイスデータと、ユーザーに焦点を当てた明確な「行動を促すフレーズ」をアプリに直接組み込むことで、ユーザーの離脱を防ぎます。</span></p>
<p><span style="vertical-align: baseline;">デベロッパー向けの高度なカスタマイズ機能により、厳選したカルーセルの作成、テーマ（「雰囲気」や「料理」など）によるクチコミや写真のフィルタ、カスタム操作ボタン（「空き状況を確認」など）の追加が可能です。ユーザーはアプリを離れることなく、意思決定に必要なコンテキストを得られます。</span></p>
<p><span style="vertical-align: baseline;">Places UI キット Pro を使用すると、アプリ内でアクションを実行するために必要なすべてのコンテキストをユーザーに提供し、ユーザー ジャーニー全体をエンドツーエンドで管理できます。</span></p></div>
<div class="block-image_full_width">
    ...
    <figure class="article-image--large
      ...
      ">
        ...
        <img alt="Nab-3" src="https://storage.googleapis.com/gweb-cloudblog-publish/images/Nab-3.max-1000x1000.png" />
        
        </a>
      
        <figcaption class="article-image__caption "><p>Places UI キット Pro を使用して、ユーザーをアプリに引き留めましょう。アプリ内で場所の詳細をコンテキストに合わせて提供することで、ユーザーはスムーズに目的を達成できるようになり、アプリのエンゲージメント向上につながります。</p></figcaption>
...
<div class="block-paragraph_advanced"><h3><span style="vertical-align: baseline;">最新のプロダクトを今すぐお試しください</span></h3>
<p><span style="vertical-align: baseline;">Google の最新プロダクトを組み合わせることで、業務の盲点を排除し、ドライバーのワークフローを合理化して、ユーザー コンバージョンを最大化できます。</span></p>
<p><span style="vertical-align: baseline;">ビジネスにおけるルートの効率と完了率を劇的に向上させませんか？</span><a href="https://developers.google.com/maps/documentation/navigation/connect?utm_source=blog&amp;utm_campaign=Q2_theme1&amp;hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Navigation Connect API</span></a><span style="vertical-align: baseline;">、</span><a href="https://developers.google.com/maps/documentation/isochrones/demo?hl=en&amp;utm_campaign=Q2_theme1" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Isochrones API</span></a><span style="vertical-align: baseline;">、</span><a href="https://mapsplatform.google.com/maps-products/places-ui-kit/?utm_source=blog&amp;utm_campaign=Q2_theme1" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Places UI キット Pro</span></a><span style="vertical-align: baseline;"> モバイル SDK（</span><a href="https://developers.google.com/maps/documentation/places/android-sdk/places-ui-kit-overview?utm_source=blog&amp;utm_campaign=Q2_theme1&amp;hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">Android</span></a></p>
<p><a href="https://developers.google.com/maps/documentation/places/android-sdk/places-ui-kit-overview?utm_source=blog&amp;utm_campaign=Q2_theme1&amp;hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">（新しいタブで開きます）</span></a><span style="vertical-align: baseline;">および </span><a href="https://developers.google.com/maps/documentation/places/ios-sdk/places-ui-kit-overview?utm_source=blog&amp;utm_campaign=Q2_theme1&amp;hl=en" rel="noopener" target="_blank"><span style="text-decoration: underline; vertical-align: baseline;">iOS</span></a><span style="vertical-align: baseline;">）を今すぐお試しください。</span></p>
<p><span style="font-style: italic; vertical-align: baseline;">- Google Maps Platform、プロダクト マネージャー、</span><strong style="font-style: italic; vertical-align: baseline;">Qi Wang</strong><br /><span style="font-style: italic; vertical-align: baseline;">- Google Maps Platform、プロダクト マネージャー、</span><strong style="font-style: italic; vertical-align: baseline;">Torben Spitzer</strong><br /><span style="font-style: italic; vertical-align: baseline;">- Google Maps Platform、プロダクト マネージャー、</span><strong style="font-style: italic; vertical-align: baseline;">Austin Wells</strong></p></div>
</details>
...
### Google、「The Forrester Wave™: Public Cloud Platforms, Q3 2026」でリーダーに選出

- **Link**: [https://cloud.google.com/blog/ja/products/compute/forrester-wave-public-cloud-platforms-q3-2026-report/](https://cloud.google.com/blog/ja/products/compute/forrester-wave-public-cloud-platforms-q3-2026-report/)
- **Published**: 2026-09-18 11:50:00
- **Fetched**: 2026-09-18 21:43:51

<details class="entry-summary">
<summary>詳細を表示</summary>
<div class="block-paragraph_advanced"><p><span style="vertical-align: baseline;">※この投稿は米国時間 2026 年 9 月 15 日に、Google Cloud blog に</span><a href="https://cloud.google.com/blog/products/compute/forrester-wave-public-cloud-platforms-q3-2026-report?e=0&amp;hl=en"><span style="text-decoration: underline; vertical-align: baseline;">投稿</span></a><span style="vertical-align: baseline;">されたものの抄訳です。</span></p>
...
<div class="block-image_full_width">
    ...
    <figure class="article-image--large
      ...
      ">
        ...
        <figcaption class="article-image__caption "><p>無料レポート <a href="https://cloud.google.com/resources/content/2026-forrester-public-cloud-platform-wave-report">The Forrester Wave™: Public Cloud Platforms, Q3 2026</a> をご覧ください。</p></figcaption>
...
<ul>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">GKE Agent Sandbox（一般提供版）と Cloud Run Sandbox（プレビュー版）を使用して、デフォルト拒否のセキュリティで従来のワークロードと並行して、</span><strong style="vertical-align: baseline;">信頼できないエージェント コードを安全に実行</strong><span style="vertical-align: baseline;">できます。これらのプロダクトにより、エージェント用に gVisor で分離された軽量の境界が 1 秒未満で（および 1 つのクラスタで毎秒最大 300 個のサンドボックスが）プロビジョニングされます。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">GKE Pod スナップショットを使用してコンテナの RAM 状態を Google Cloud Storage に直接シリアル化することで、</span><strong style="vertical-align: baseline;">アイドル状態のコンピューティング費用を最大 90% 削減</strong><span style="vertical-align: baseline;">できます。これにより、アイドル状態のエージェント セッションを約 100 ミリ秒で一時停止し、約 280 ミリ秒で再開できます。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">GKE Inference Gateway の予測ルーティングにより、</span><strong style="vertical-align: baseline;">最初のトークンまでの時間（TTFT）を最大 70%短縮</strong><span style="vertical-align: baseline;">し、キャッシュ ヒット率を 2 倍に向上させることができます。GKE Inference Gateway は継続的にトレーニングされた ML モデルを使用して、リアルタイムのトラフィック データに基づいてルーティングを決定します。</span></p>
</li>
</ul>
...
<ul>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">SAP BDC Connect for BigQuery（一般提供版）を使用して、コストのかかるデータの移動を必要とせずに、</span><strong style="vertical-align: baseline;">エージェントがライブの財務記録やサプライ チェーン記録をクエリできるようにする。</strong><span style="vertical-align: baseline;">SAP BDC Connect for BigQuery により、SAP システムと BigQuery の間でゼロコピーの双方向データ共有が可能になります。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">Knowledge Catalog を使用して、データ資産全体にわたってビジネス上の意味をマッピングおよび推論する。Google とパートナーのデータ プラットフォーム、セマンティック モデル、サードパーティのカタログ全体でネイティブ コンテキストを集約し、それらを管理された信頼できる唯一の情報源として統合できるようになりました。</span></p>
</li>
<li style="vertical-align: baseline;">
<p><span style="vertical-align: baseline;">レイクハウス フェデレーションを使用して、</span><strong style="vertical-align: baseline;">PostgreSQL データプレーンから Iceberg と BigQuery のライブデータにアクセスする。</strong><span style="vertical-align: baseline;">データの移動を必要とせずに、AlloyDB のトランザクション データと BigQuery または Iceberg の過去の分析情報をライブで結合できます。また、Datastream を使用して、AlloyDB から BigQuery および Iceberg テーブルにデータを継続的に複製することもできます。</span></p>
</li>
</ul>

---
layout: default
title: GCP News - 2025-11-14
news_counter: 1
last_updated: 2026-08-27 21:31:32 JST
---

# GCP Updates - 2025-11-14

## Google Online Security Blog

### Rust in Android: move fast and fix things

- **Link**: [http://security.googleblog.com/2025/11/rust-in-android-move-fast-fix-things.html](http://security.googleblog.com/2025/11/rust-in-android-move-fast-fix-things.html)
- **Published**: 2025-11-14 01:59:00
...
<ol><li id="fn1">
<p>
     The DevOps Research and Assessment (DORA) program is published by Google Cloud.&nbsp;<a href="http://feeds.feedburner.com/GoogleOnlineSecurityBlog#fnref1" rev="footnote">&#8617;</a>

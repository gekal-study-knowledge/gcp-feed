...
<h4 id="what-should-i-do_96" tabindex="-1">What should I do?</h4>
...
<section>
<h3 id="gcp-2025-071-gdcvmware" tabindex="-1">GDC (VMware)</h3>
...
<h4 id="what-should-i-do_97" tabindex="-1">What should I do?</h4>
...
<section>
<h3 id="gcp-2025-071-gkeaws" tabindex="-1">GKE on AWS</h3>
<table>
<thead>
<tr>
<th>Description</th>
...
<h4 id="what-should-i-do_98" tabindex="-1">What should I do?</h4>
...
<section>
<h3 id="gcp-2025-071-gkeazure" tabindex="-1">GKE on Azure</h3>
<table>
<thead>
<tr>
<th>Description</th>
...
<h4 id="what-should-i-do_99" tabindex="-1">What should I do?</h4>
...
<section>
<h3 id="gcp-2025-071-gdcbm" tabindex="-1">GDC (bare metal)</h3>
<table>
<thead>
<tr>
<th>Description</th>
...
<h4 id="what-should-i-do_100" tabindex="-1">What should I do?</h4>
...
- **Link**: [https://docs.cloud.google.com/kubernetes-engine/security-bulletins#gcp-2025-070](https://docs.cloud.google.com/kubernetes-engine/security-bulletins#gcp-2025-070)
- **Published**: 2025-12-02 09:00:00
- **Fetched**: 2026-08-27 21:31:34

<details class="entry-summary">
<summary>詳細を表示</summary>
<p><strong>Published: </strong>2025-12-02<br /> <strong>Updated: </strong>2026-03-25<br /> <strong>Reference:</strong> <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-40018">CVE-2025-40018</a></p><p><strong>2026-03-25 Update: </strong> Added patch versions for Ubuntu nodes with GKE.</p><p><strong>2025-12-11 Update: </strong> Added patch versions and a severity rating for GDC (VMware).</p>
<section>
<h3 id="gcp-2025-070-gke" tabindex="-1">GKE</h3>
<p><strong>Updated: </strong>2026-03-25</p>
<table>
<thead>
<tr>
...
<p>Clusters using <a href="https://docs.cloud.google.com/kubernetes-engine/docs/concepts/sandbox-pods">GKE Sandbox</a> aren't impacted.</p>
<h4 id="what-should-i-do_101" tabindex="-1">What should I do?</h4>
<p><strong>2026-03-25 Update</strong>: The following versions of GKE are updated with code to fix this vulnerability on Ubuntu. Upgrade your Ubuntu node pools to the following versions or later:</p>
<ul>
<li>1.35.1-gke.1396000</li>
<li>1.34.4-gke.1047000</li>
...
<section>
<h3 id="gcp-2025-070-gdcvmware" tabindex="-1">GDC (VMware)</h3>
<p><strong>Updated: </strong>2025-12-11</p>
<table>
<thead>
<tr>
...
<h4 id="what-should-i-do_102" tabindex="-1">What should I do?</h4>
<p>The following versions of GDC (VMware) are updated with code to fix this vulnerability.
            Upgrade your GDC (VMware) clusters to the following versions or later:</p>
<ul>
<li>1.31.1100-gke.40</li>
...
<section>
<h3 id="gcp-2025-070-gkeaws" tabindex="-1">GKE on AWS</h3>
<table>
<thead>
<tr>
<th>Description</th>
...
<h4 id="what-should-i-do_103" tabindex="-1">What should I do?</h4>
<p><aside class="note"><strong>Note: </strong>Patch versions and a severity assessment for GKE on AWS are in progress. We'll update this bulletin with that information when it's available.</aside></p>
</td>
<td>Pending</td>
</tr>
...
<section>
<h3 id="gcp-2025-070-gkeazure" tabindex="-1">GKE on Azure</h3>
<table>
<thead>
<tr>
<th>Description</th>
...
<h4 id="what-should-i-do_104" tabindex="-1">What should I do?</h4>
<p><aside class="note"><strong>Note: </strong>Patch versions and a severity assessment for GKE on Azure are in progress. We'll update this bulletin with that information when it's available.</aside></p>
</td>
<td>Pending</td>
</tr>
...
<section>
<h3 id="gcp-2025-070-gdcbm" tabindex="-1">GDC (bare metal)</h3>
<table>
<thead>
<tr>
<th>Description</th>
...
<h4 id="what-should-i-do_105" tabindex="-1">What should I do?</h4>
<p>There is no action required. GDC software for bare metal isn't affected as it does not bundle an operating system in its distribution.</p>
</td>
<td>None</td>
</tr>
